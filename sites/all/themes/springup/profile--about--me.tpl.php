...
<!--About section-->
<section class="ui-state-default aboutMe margin-bottom" data-name="profile_about_me">
  <div class="container white">
    <h1 class="sprinUp-title prfile-title" style="cursor: crosshair;">
      <?php print $elements['#title'] ?>
    ...
    <div class="row margin-bottom">
      <div class="col-xs-12 col-sm-3 col-md-3 pull-right">
        <?php print render($elements['view']['field_about_image'][0]); ?>  
      </div>
      <div class="col-xs-12 col-sm-9 col-md-9">
        <?php print render($elements['view']['field_about_me'][0]); ?>
      </div>
    </div>
  </div>
</section>
